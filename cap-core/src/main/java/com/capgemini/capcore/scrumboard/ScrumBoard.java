...
public class ScrumBoard implements Serializable {
	...
	public ScrumBoard() {
		this.notStartedList = new ArrayList<ScrumNote>();
		this.inProgressList = new ArrayList<ScrumNote>();
		this.doneList = new ArrayList<ScrumNote>();
	}

//	/**
//	 * Singleton method - gets a new instance if none exists or return the
//	 * existing one.
//	 * 
//	 * @return a ScrumBoard
//	 */
